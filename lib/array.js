...
internals.Array.prototype._base = function (value, state, options) {
    ...
    if (options.convert && this._flags.allowSingle && !Array.isArray(result.value)) {
...
internals.Array.prototype.allowSingle = function (enabled) {

    var obj = this.clone();
    obj._flags.allowSingle = enabled === undefined ? true : !!enabled;
    return obj;
}
