...
internals.annotate = function (colorCode = true) {

    const redFgEscape = colorCode ? '\u001b[31m' : '';
    const redBgEscape = colorCode ? '\u001b[41m' : '';
    const endColor = colorCode ? '\u001b[0m' : '';
    ...
    let message = internals.safeStringify(obj, 2)
        ...
        .replace(replacers.missing, ($0, $1, $2) => redBgEscape + '"' + $1 + '"' + endColor + refFgEscape + ' [' + $2 + ']: -- missing --' + endColor)
