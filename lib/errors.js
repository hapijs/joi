...
internals.Err = function (type, context, state, options, localOptions) {
...
internals.Err.prototype.toString = function () {
    ...
    if (this.localOptions.label) {
        this.context.key = this.localOptions.label;
    }
...
exports.create = function (type, context, state, options, localOptions) {

    return new internals.Err(type, context, state, options, localOptions);
};
...
exports.process = function (errors, object) {
    ...
    const processErrors = function (localErrors, parent) {
        ...
        for (let i = 0; i < localErrors.length; ++i) {
            ...
            if (item.localOptions.error) {
                return item.localOptions.error;
            }
