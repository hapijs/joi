...
exports.Report = class {
    ...
    constructor(code, value, local, flags, state, prefs) {
        ...
        this.local = local || {};
        this.local.label = exports.label(this.flags, this.state, this.prefs);
    ...
    _template(messages, code) {
        ...
        return internals.template(this.value, messages, code, this.state, this.prefs);
    }
};
...
exports.label = function (flags, state, prefs) {

    return flags.label ||
        internals.label(state.path) ||
        internals.template(null, prefs.messages, 'root', state, prefs) ||
