...
exports.Err = class {
    ...
    constructor(type, context, state, options, flags, code) {
...
exports.create = function (type, context, state, options, flags, code) {

    return new exports.Err(type, context, state, options, flags, code);
};
