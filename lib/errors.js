...
exports.Report = class {
    ...
    constructor(type, context, state, options) {
        ...
        this.context.label = state.flags.label || internals.label(state.path);
    ...
    toString() {
        ...
        const wrapArrays = Common.default(localized.messages && localized.messages.wrapArrays, Language.errors.messages.wrapArrays);
