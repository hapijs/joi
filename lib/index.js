...
internals.root = function () {
    ...
    for (const method of ['allow', 'custom', 'disallow', 'equal', 'exist', 'forbidden', 'invalid', 'not', 'optional', 'options', 'prefs', 'preferences', 'required', 'valid', 'when']) {
    ...
    if (Trace && Trace.setup) {                                         // $lab:coverage:ignore$
        Trace.setup(root);
    }
