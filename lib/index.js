...
internals.root = function () {
    ...
    root.assert = function (value, schema, ...args/* [message], [options]*/) {
    ...
    root.validate = function (value, schema, options) {

        if (!schema) {
            return any.validate(value);
        }

        return this.compile(schema).validate(value, options);
    };
