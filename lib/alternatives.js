...
exports.create = function (/* alternatives */) {
    ...
    var alt = new internals.Alternatives();
    return arguments.length ? alt.attempt.apply(alt, arguments) : alt;
};
...
internals.Alternatives.prototype.attempt = function (/* schemas */) {
