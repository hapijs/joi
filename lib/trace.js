...
internals.Tracer = class {
    ...
    _register(schema) {
        ...
        const { filename, line } = schema._flags._tracerLocation || Pinpoint.location(4);   // internals.entry(), exports.entry(), validate(), caller
...
internals.Store = class {
    ...
    entry(schema) {
        ...
        if (schema._whenSources) {
            return this._whens(schema, 'entry');
        }
    ...
    log(source, name, result, schema) {
        ...
        if (schema._whenSources) {
            return this._whens(schema, 'log', source, name, result);
        }
    ...
    value(source, value, schema) {
        ...
        if (schema._whenSources) {
            return this._whens(schema, 'value', source, value);
        }
