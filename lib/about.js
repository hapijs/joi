...
exports.describe = function (schema) {
    ...
    if (schema._inner.notes.length) {
        description.notes = schema._inner.notes.slice();
    }

    if (schema._inner.tags.length) {
        description.tags = schema._inner.tags.slice();
    }

    if (schema._inner.meta.length) {
        description.meta = schema._inner.meta.slice();
    }

    if (schema._inner.examples) {
        description.examples = schema._inner.examples.slice();
    }
