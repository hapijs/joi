...
internals.ObjectType.prototype.allowAnyKey = function () {

    this._allowAnyKey = true;
    return this;
};
...
internals.ObjectType.prototype._traverse = function (topObj, topConfig, errors, topKeyPath) {
    ...
    var traverse = function (obj, config, errors, keyPath) {
        ...
        if (self._allowAnyKey !== true && keys.length) {                                                                                  // Only error on unknown keys when config specifies a structure
