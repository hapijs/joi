...
module.exports = Any.extend({
    ...
    initialize: function (schema) {
        ...
        schema._inners.dependencies = null;
        schema._inners.keys = null;
        schema._inners.patterns = null;
        schema._inners.renames = null;
    },
    ...
    modify: function (schema, id, replacement) {
        ...
        const modified = schema.$_overrideRules('assert', (rule) => {
