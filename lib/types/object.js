    ...
    _base(value, state, prefs) {
        ...
        if (type === 'object') {
            if (prefs.nonEnumerables) {
                ...
                const source = value;
                value = Object.create(Object.getPrototypeOf(source));
            ...
            value.prototype = Hoek.clone(source.prototype);
            Object.defineProperty(value, 'name', { value: source.name, writable: false });
            Object.assign(value, source);
        }
        ...
        if (unprocessed.size &&
            ...
            for (const key of unprocessed) {
                const localState = this._state(key, [...state.path, key], [value]);
                const item = value[key];
