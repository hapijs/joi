        ...
        for (const rename of this._inner.renames) {
            ...
            for (const from of matches) {
                ...
                if (!rename.options.multiple &&
                    ...
                    errors.push(this.createError('object.rename.multiple', { from, to, pattern }, state, options));
                    if (options.abortEarly) {
                        return false;
                    }
                }
                ...
                if (Object.prototype.hasOwnProperty.call(target, to) &&
                    ...
                    errors.push(this.createError('object.rename.override', { from, to, pattern }, state, options));
                    if (options.abortEarly) {
                        return false;
                    }
                }
