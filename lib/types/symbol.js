    ...
    _base(value, state, options) {
        ...
        if (options.convert) {
            ...
            if (this._flags.allowOnly) {
                ...
                return { value, errors: this.createError('symbol.map', { value, map: this._inner.map }, state, options) };
            }
        }
        ...
        return { value, errors: this.createError('symbol.base', { value }, state, options) };
    }
