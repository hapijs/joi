                ...
                if (match) {
                    ...
                    if (domain) {
                        ...
                        if (domain.hostname) {
                            ...
                            if (typeof domain.hostname === 'string' || domain.hostname instanceof RegExp) {

                                if (!isMatch(domain.hostname)) {
                                    return helpers.error('string.uri.hostname', { value: matched, expected: String(domain.hostname) });
                                }
                            ...
                            if (Array.isArray(domain.hostname)) {
                                ...
                                let matches = 0;
                                domain.hostname.forEach((matcher) => {
