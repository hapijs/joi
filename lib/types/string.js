    ...
    rules: {
        ...
        pattern: {
            ...
            method(regex, options = {}) {
                ...
                Assert(regex instanceof RegExp || typeof regex === 'string', 'regex must be a RegExp or a RegExp string');

                if (typeof regex === 'string') {
                    const match = regex.match(/^([\/~@;%#'])(.*?)\1([gimsuy]*)$/);
                    const regexFromString = match ?
                        new RegExp(
                            match[2],
                            match[3]
                                .split('')
