    ...
    rules: {
        ...
        domain: {
            ...
            jsonSchema(rule, res) {
                ...
                res.pattern = internals.domainJsonSchemaPattern(rule.address || rule.args.options || {});      // $lab:coverage:ignore$
                return res;
            }
        },
...
internals.tldValues = function (values) {
    ...
    if (values instanceof Set) {
        return values.size ? [...values] : null;                // $lab:coverage:ignore$
    }
...
internals.tldPatternValues = function (values, allowUnicode) {
    ...
    for (const tld of tlds) {
        ...
        if (unicode &&
            ...
            patterns.add(internals.caseInsensitiveLiteral(unicode));
        }
    }
