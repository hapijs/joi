...
const JsonString = require('../json-schema/string');
...
module.exports = Any.extend({
    ...
    jsonSchema(schema, res, mode, options) {
        ...
        return JsonString.applyBase(schema, res);
    },
    ...
    rules: {
        ...
        alphanum: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, '^[a-zA-Z0-9]+$');
            }
        },
        ...
        base64: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, JsonString.base64Pattern(rule.args.options, internals.base64Regex));
            }
        },
        ...
        dataUri: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, JsonString.dataUriPattern(rule.args.options, internals.base64Regex));
            }
        },
        ...
        domain: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, JsonString.domainPattern(rule.address, internals.minDomainSegments));
            }
        },
        ...
        hex: {
            ...
            jsonSchema(rule, res, isOnly, mode) {
                ...
                return JsonString.appendPattern(res, JsonString.hexPattern(rule.args.options, mode));
            }
        },
        ...
        hostname: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, JsonString.hostnamePattern(internals.minDomainSegments));
            }
        },
        ...
        ip: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, JsonString.ipPattern(rule.args.options));
            }
        },
        ...
        pattern: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, rule.args.regex.source);
            },
            args: ['regex', 'options'],
            multi: true
        },
        ...
        token: {
            ...
            jsonSchema(rule, res) {
                ...
                return JsonString.appendPattern(res, '^[A-Za-z0-9_]+$');
            }
        },
