...
internals.createRegex = function (options) {
    ...
    let customScheme = '';
    if (options.scheme) {
        Assert(Common.isRegExp(options.scheme) || typeof options.scheme === 'string' || Array.isArray(options.scheme), 'scheme must be a RegExp, String, or Array');
        ...
        for (let i = 0; i < schemes.length; ++i) {
            ...
            Assert(Common.isRegExp(scheme) || typeof scheme === 'string', 'scheme at position ' + i + ' must be a RegExp or String');

            if (Common.isRegExp(scheme)) {
