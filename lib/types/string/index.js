...
module.exports = Any.extend({
    ...
    coerce: {
        ...
        method: function (schema, value, { state, prefs }) {
            ...
            const normalize = schema.getRule('normalize');
            if (normalize) {
                value = value.normalize(normalize.args.form);
            }

            const casing = schema.getRule('case');
            if (casing) {
            ...
            if (schema._inners.replacements) {
                for (const replacement of schema._inners.replacements) {
                    value = value.replace(replacement.pattern, replacement.replacement);
                }
            }

            const hex = schema.getRule('hex');
            if (hex &&
            ...
            if (schema.getRule('isoDate')) {
                ...
                if (!valid) {
                    return { value, errors: schema.createError('string.isoDate', value, null, state, prefs) };
                }
            }

            if (schema._flags.truncate) {
                const rule = schema.getRule('max');
                if (rule) {
                    let limit = rule.args.limit;
                    if (Common.isResolvable(limit)) {
                        limit = limit.resolve(value, state, prefs);
                        if (!Common.limit(limit)) {
                            return { value, errors: schema.createError('any.ref', limit, { ref: rule.args.limit, arg: 'limit', reason: 'must be a positive integer' }, state, prefs) };
                        }
                    }
    ...
    rules: {
        ...
        case: {
            method: function (direction) {
                ...
                return this.addRule({ name: 'case', args: { direction } });
            },
        ...
        creditCard: {
            method: function () {
                ...
                return this.addRule('creditCard');
            },
            validate: function (value, helpers) {
        ...
        domain: {
            method: function (options) {
                ...
                return this.addRule({ name: 'domain', args: { options } });
            },
            validate: function (value, helpers, { options }) {
        ...
        email: {
            method: function (options = {}) {
                ...
                return this.addRule({ name: 'email', args: { options }, regex });
            },
        ...
        guid: {
            ...
            method: function (options = {}) {
                ...
                return this.addRule({ name: 'guid', args: { options }, regex });
            },
        ...
        hex: {
            method: function (options = {}) {
                ...
                return this.addRule({ name: 'hex', args: { options } });
            },
            validate: function (value, helpers, { options }) {
        ...
        insensitive: {
            method: function () {
                ...
                return this.setFlag('insensitive', true);
            }
        },
        ...
        ip: {
            method: function (options = {}) {
                ...
                return this.addRule({ name: 'ip', args: { options }, versions, regex });
            },
        ...
        isoDuration: {
            method: function () {
                ...
                return this.addRule('isoDuration');
            },
            validate: function (value, helpers) {
        ...
        normalize: {
            method: function (form = 'NFC') {
                ...
                return this.addRule({ name: 'normalize', args: { form } });
            },
        ...
        pattern: {
            ...
            method: function (regex, options = {}) {
                ...
                return this.addRule({ name: 'pattern', args: { regex, options }, errorCode });
            },
        ...
        trim: {
            method: function (enabled = true) {
                ...
                return this.addRule({ name: 'trim', args: { enabled } });
            },
        ...
        truncate: {
            method: function (enabled = true) {
                ...
                return this.setFlag('truncate', enabled);
            }
        },
        ...
        uri: {
            method: function (options = {}) {
                ...
                return this.addRule({ name: 'uri', args: { options }, regex });
            },
            validate: function (value, helpers, { options }, { regex }) {
...
internals.length = function (schema, name, limit, operator, encoding) {
    ...
    return schema.addRule({ name, method: 'length', args: { limit, encoding }, operator });
};
