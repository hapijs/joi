...
internals.String = class extends Any {
    ...
    hex(options = {}) {
        ...
        Utils.assertOptions(options, ['byteAligned']);
    ...
    trim(enabled = true) {
        ...
        if (!enabled) {
            return this._ruleRemove('trim');
        }

        return this._rule('trim', { convert: true });
    }

    truncate(enabled) {

        return this._flag('truncate', enabled !== false);
    }
