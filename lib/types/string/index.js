...
internals.String = class extends Any {
    ...
    _length(name, limit, operator, encoding) {
        ...
        return this._rule({ name, method: 'length', args: { limit, encoding }, operator });
    }
};
...
Common.extend(internals.String, 'rules', {
    ...
    case: {
        method: function (value, helpers, { direction }) {
    ...
    length: {
        method: function (value, helpers, { limit, encoding }, { name, operator, args }) {
    ...
    normalize: {
        method: function (value, { error }, { form }) {
    ...
    pattern: {
        method: function (value, helpers, { regex, options }, { errorCode }) {
    ...
    trim: {
        method: function (value, helpers, { enabled }) {
