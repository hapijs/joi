...
internals.String = class extends Any {
    ...
    host() {
        // NOTE: I want to use above host validation here how to do that?
        return this._test('host', undefined, function (value, state, options) {
            if (/^[a-zA-Z0-9\.\-\_]+\:[0-9]{1,5}$/.test(value) &&
                parseInt(value.split(':')[1]) <= 65535) {
                    return value;
            }

            return this.createError('string.host', { value }, state,)
        });
    }
