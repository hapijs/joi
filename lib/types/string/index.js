...
internals.String = class extends Any {
    ...
    case(direction) {
        ...
        return this._rule('case', { args: { direction }, convert: true });
    }
    ...
    pattern(regex, options = {}) {
        ...
        return this._rule('pattern', { args: { regex, options }, errorCode, multi: true });
    }
...
Common.extend(internals.String, 'rules', {
    ...
    length: {
        method: function (value, helpers, { limit, encoding }, { alias, operator, args }) {
