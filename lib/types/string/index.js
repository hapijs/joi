...
internals.String = class extends Any {
    ...
    capitalize() {
        ...
        const obj = this._test('capitalize', undefined, function (value, state, options) {
            ...
            return this.createError('string.capitalize', { value }, state, options);
        });

        obj._flags.capitalize = true;
        return obj;
    }
