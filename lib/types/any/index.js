...
module.exports = internals.Any = class {
    ...
    example(...examples) {
        ...
        for (let i = 0; i < examples.length; ++i) {
            ...
            const localState = new State('', [], options.parent !== undefined ? [options.parent] : [null]);
    ...
    _finalizeValue(value, originalValue, errors, state, options) {
        ...
        if (value !== undefined) {
            ...
            finalValue = this._flags.default(value, state.ancestors, options);
        }
            ...
            if (this._flags.default.length > 0) {
