...
module.exports = internals.Any = class {
    ...
    _validate(value, state, options, reference) {
        ...
        const getCurrentValue = () => {
            ...
            if (value !== undefined) {
                return this._flags.raw ? originalValue : value;
            }
            else if (options.noDefaults) {
                return value;
            }
            else if (Ref.isRef(this._flags.default)) {
                return this._flags.default(state.parent, options);
            }
            ...
            return Hoek.clone(this._flags.default);
        };
        ...
        if (presence === 'optional') {
            if (value === undefined) {
                ...
                if (this._type === 'object' && !options.noDefaults) {
                    if (isDeepDefault) {
                        value = {};
                    }
                    else if (this._flags.default !== undefined) {
