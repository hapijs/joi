...
internals.Link = class extends Any {
    ...
    _init(ref) {
        ...
        obj._immutables.link = { ref };
        return obj;
    }

    _base(value, state, prefs) {

        const ref = this._immutables.link.ref;
    ...
    describe() {
        ...
        description.link = { ref: this._immutables.link.ref.describe() };
        return description;
    }
    ...
    when(...args) {
        ...
        const ref = this._immutables.link.ref.clone();
        ++ref.ancestor;
        ref.updateDisplay();
