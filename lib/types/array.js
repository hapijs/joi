    ...
    items: function (value, { schema, error, state, prefs }) {
        ...
        for (let i = 0; i < il; ++i) {
            ...
            if (!schema._flags.sparse &&
                ...
                errors.push(error('array.sparse', { key, path, pos: i, value: undefined }, schema._state(key, path)));
                if (prefs.abortEarly) {
                    return errors;
                }
...
internals.Array.prototype._casts = Object.assign({}, internals.Array.prototype._casts, {
