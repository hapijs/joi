...
Common.extend(internals.Array, 'rules', {
    ...
    has: {
        method: function (value, { state, prefs, error, schema }, { schema: has }) {
    ...
    items: {
        method: function (value, { schema, error, state, prefs }) {
    ...
    sort: {
        method: function (value, { error, state, prefs, schema }, { options }) {
    ...
    unique: {
        method: function (value, { state, error, schema }, { comparator: raw, options }, { comparator, path }) {
