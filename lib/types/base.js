...
internals.BaseType.prototype._exclusive = function (peers) {
...
internals.BaseType.prototype.exclusive = function () {

    this.add('exclusive', this._exclusive(Array.prototype.slice.call(arguments)), arguments);
    return this;
};
