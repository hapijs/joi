...
module.exports = Any.extend({
    ...
    initialize: function (schema) {
        ...
        schema._inners.truthy = new Values();
        schema._inners.falsy = new Values();
    },
    ...
    coerce: function (schema, value, helpers) {
        ...
        if (typeof value !== 'boolean') {
            value = schema._inners.truthy.has(value, null, null, schema._flags.insensitive) ||
                (schema._inners.falsy.has(value, null, null, schema._flags.insensitive) ? false : value);
        }
