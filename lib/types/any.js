...
module.exports = internals.Any = class {
    ...
    when(condition, options) {
        ...
        const alternativeOptions = {
            is: options.is,
            then: options.then && this.concat(Cast.schema(this._currentJoi, options.then)),
            otherwise: options.otherwise && this.concat(Cast.schema(this._currentJoi, options.otherwise))
        };
