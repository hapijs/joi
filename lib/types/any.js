...
module.exports = internals.Any = class {
    ...
    options(options) {
        ...
        const obj = this.clone();
        obj._settings = Common.settings(obj._settings, options);
        return obj;
    }
    ...
    rule(options) {
        ...
        for (let i = start; i < obj._tests.length; ++i) {
            const test = Object.assign({}, obj._tests[i]);      // Shallow cloned
    ...
    strict(enabled) {
        ...
        obj._settings = Common.settings(obj._settings, { convert });
        return obj;
    }
    ...
    concat(source) {
        ...
        obj._settings = obj._settings ? Common.settings(obj._settings, source._settings) : source._settings;
    ...
    createError(type, context, state, options) {
        ...
        return new Errors.Report(type, context, state, options);
    }
    ...
    _match(value, state, options, reference) {

        return !Validator.validate(value, this, state, options, reference).errors;
    }
    ...
    _validate(value, state, options) {
        ...
        return Validator.validate(value, this, { ...state, flags: this._flags }, options);
    }
