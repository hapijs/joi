...
module.exports = internals.Any = class {
    ...
    only(...invalid) {
        ...
        Hoek.assert(invalid.length === 0, 'Method does not accept arguments');

        return this._flag('only', true);
    }
    ...
    when(condition, options) {
        ...
        const obj = this._root.alternatives().when(condition, alternativeOptions);
        obj._baseType = this;
        return obj;
    }
