...
module.exports = internals.Any = class {
    ...
    concat(source) {
        ...
        obj._settings = obj._settings ? Settings.concat(obj._settings, source._settings) : source._settings;
    ...
    createError(type, context, state, options, flags = this._flags) {
        ...
        return new Errors.Report(type, context, state, options, flags);
    }
    ...
    _validate(value, state, options) {
        ...
        return Validator.validate(value, this, state, options);
    }
