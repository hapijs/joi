...
internals.Object.prototype.schema = function () {

    return this._test('schema', null, (value, state, options) => {
...
internals.Object.prototype.ref = function () {

    return this._test('ref', null, (value, state, options) => {
