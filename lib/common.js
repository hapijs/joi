...
exports.State = class {
    ...
    constructor(path, ancestors, state, schema) {

        this.path = path;
        this.ancestors = ancestors;
        this.mainstay = state.mainstay;
        this.flags = schema._flags;
    ...
    entry(schema, reference) {
        ...
        return new exports.State([], ancestors, this, schema);
    }

    localize(path, ancestors, schema) {

        return new exports.State(path, ancestors, this, schema);
    }
};
