...
exports.Ids = internals.Ids = class {
    ...
    labels(path, behind = []) {
        ...
        Hoek.assert(this._reachable, 'Schema type is not reachable');
    ...
    _collect(path, behind = [], nodes = []) {
        ...
        Hoek.assert(node.schema._definition.modify, 'Schema node', [...behind, ...path].join('.'), 'does not support manipulation');
