...
exports.errors = {
    ...
    alternatives: {
        ...
        types: 'must be one of {{types}}',
        match: 'does not match any of the allowed types'
    },
    array: {
        ...
        orderedLength: 'must contain at most {{limit}} items',
        ref: 'references "{{ref}}" which is not a positive integer',
        sparse: 'must not be a sparse array item',
    ...
    object: {
        ...
        assert: 'is invalid because "{{ref}}" failed to {{message}}',
        ...
        schema: 'must be a Joi schema of {{type}} type',
