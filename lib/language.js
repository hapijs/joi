...
exports.errors = {
    ...
    string: {
        ...
        routingNumber: 'must be a valid routing number',
        isoCountryCode: 'must be a valid ISO 3166 country code',
        accountNumber: 'must be a valid account number',
        expiryMonth: 'must be a valid expiry month',
        expiryYear: 'must be a valid expiry year',
        cvc: 'must be a valid cvc',
        isoCurrencyCode: 'must be a valid ISO 3166 currency code',
        SSN: 'must be a valid social security number',
        EIN: 'must be a valid employer identification number',
