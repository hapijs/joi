...
internals.String.prototype._base = function (value, state, options) {
    ...
    if (typeof value === 'string' &&
        ...
        if (this._flags.truncate) {
            const n = value.length > this._flags.truncate ? this._flags.truncate : value.length;
...
internals.String.prototype.truncate = function (limit) {

    const obj = this._test('truncate', undefined, (value, state, options) => {
        ...
        return this.createError('string.truncate', { limit : limit }, state, options);
    });

    obj._flags.truncate = limit;
    return obj;
};
