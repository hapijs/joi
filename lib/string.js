...
internals.String.prototype.uri = function () {
    /**
     *
     * An URI is defined in [RFC-3986](http://tools.ietf.org/html/rfc3986).
     *
     ...
     * **scheme**
     *
     * `^[a-zA-Z][a-zA-Z0-9+\.-]*:` captures the scheme being used.
     *
     ...
     *
     * - `(\[(((([0-9A-F]){1,4}:){6}(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|::(([0-9A-F]){1,4}:){5}(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|([0-9A-F]){1,4}::(([0-9A-F]){1,4}:){4}(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|(([0-9A-F]){1,4}:){0,1}([0-9A-F]){1,4}::(([0-9A-F]){1,4}:){3}(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|(([0-9A-F]){1,4}:){0,2}([0-9A-F]){1,4}::(([0-9A-F]){1,4}:){2}(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|(([0-9A-F]){1,4}:){0,3}([0-9A-F]){1,4}::([0-9A-F]){1,4}:(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|(([0-9A-F]){1,4}:){0,4}([0-9A-F]){1,4}::(([0-9A-F]){1,4}:([0-9A-F]){1,4}|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|(([0-9A-F]){1,4}:){0,5}([0-9A-F]){1,4}::([0-9A-F]){1,4}|(([0-9A-F]){1,4}:){0,6}([0-9A-F]){1,4}::)|(v[0-9A-F]+\.[a-zA-Z0-9-\._~!$&'()*+,;=:]+))\]|((0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}(0?0?[0-9]|0?[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])|[a-zA-Z0-9-\._~%0-9A-F!$&'()*+,;=]{0,255})`
     *   is the complicated part. This identifies the host and handles all formats of IP addresses as well as domain names.
     *
