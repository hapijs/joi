...
internals.String.prototype.uri = function (uriOptions) {
    ...
    return this._test('uri', uriOptions, function (value, state, options) {
        ...
        if (customScheme) {
            return Errors.create('string.uriCustomScheme', { scheme: customScheme }, state, options);
        }
