...
internals.String.prototype.ip = function () {

    return this._test('ip', undefined, function (value, state, options) {

        if (isIP.test(value)) {
            return null;
        }

        return Errors.create('string.ip', null, state, options);
    });
};


internals.String.prototype.ipv4 = function () {

    return this._test('ipv4', undefined, function (value, state, options) {

        if (isIP.v4(value)) {
            return null;
        }

        return Errors.create('string.ipv4', null, state, options);
    });
};


internals.String.prototype.ipv6 = function () {

    return this._test('ipv6', undefined, function (value, state, options) {

        if (isIP.v6(value)) {
            return null;
        }

        return Errors.create('string.ipv6', null, state, options);
    });
};


internals.String.prototype.ipvFuture = function () {

    return this._test('ipvFuture', undefined, function (value, state, options) {

        if (isIP.future(value)) {
            return null;
        }

        return Errors.create('string.ipvFuture', null, state, options);
    });
};
