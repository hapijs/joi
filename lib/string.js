...
internals.String.prototype.version = function () {

    return this._test('version', undefined, (value, state, options) => {

        if (Semver.valid(value)) {
            return null;
        }

        return this.createError('string.version', { value }, state, options);
    });
};
