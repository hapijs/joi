...
internals.String.prototype.equal = function(equal){

    return this._test('equals', equals, function(value, state, options){
        equals = equals.toString().trim();
        value = value.toString().trim();
        if(equals === value)
            return null;

        return Errors.create('string.equal',
            null, state, options);
    });
};
