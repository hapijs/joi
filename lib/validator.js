...
internals.prefs = function (schema, prefs) {
    ...
    if (schema._preferences) {
        ...
        prefs = Common.preferences(schema._language ? Common.preferences({ language: schema._language }, prefs) : prefs, schema._preferences);
        if (isDefaultOptions) {
    ...
    if (schema._language) {
        return Common.preferences({ language: schema._language }, prefs);
    }
