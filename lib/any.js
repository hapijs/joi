...
internals.Any.prototype._test = function (name, arg, func, description) {

    const obj = this.clone();
    obj._tests.push({ func, name, arg, description });
    return obj;
};
...
internals.Any.prototype.describe = function () {
    ...
    for (let i = 0; i < this._tests.length; ++i) {
        ...
        else if (typeof validator.description === 'function') {
            item.description = validator.description(item.arg);
        }
