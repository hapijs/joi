...
internals.Any.prototype.xor = function () {
    ...
    this._dependency('xor', peers, function (value, state, options) {
        ...
        if (present === 0) {
            return (present === 1 ? null : Errors.create('any.xor.missing', { value: peers }, state, options));
        }
...
internals.Any.prototype.default = function (to) {
    ...
    this._mutate(function (value, state, options) {
        ...
        if (!state.parent) {
            return internals.Any.error('any.default.parent', null, state);

        }

        if (state.parent[state.key] === undefined) {
            state.parent[state.key] = to;
        }
