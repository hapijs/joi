...
internals.Any.prototype._validate = function (value, state, options, reference) {
    ...
    if ((this._flags.presence === undefined && options.requiredAsDefault === false) ||
        this._flags.presence === 'optional') {

        if (value === undefined) {
            return finish();
        }
    }
    else if (this._flags.presence === undefined || this._flags.presence === 'required') {
