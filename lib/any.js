...
internals.Any.prototype.clone = function () {
    ...
    obj._custom = Hoek.clone(this._custom);
...
internals.Any.prototype.concat = function (schema) {
    ...
    if (this._type === 'any' && schema._type !== 'any') {
        ...
        var keysToRestore = ['_settings', '_custom', '_valids', '_invalids', '_tests', '_refs', '_flags', '_description', '_unit',
...
internals.Any.prototype.custom = function (func, message) {
...
internals.Any.prototype._validate = function (value, state, options, reference) {
    ...
    // Check custom
    if (this._custom && !this._custom.func(value)) {
        errors.push(Errors.create('any.custom', {message: this._custom.message}, state, options));
    }
