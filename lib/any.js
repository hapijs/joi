...
internals.Any.prototype.options = function (options) {
    ...
    var obj = this.clone();
    obj._settings = Utils.applyToDefaults(obj._settings || {}, options);
    return obj;
};
...
internals.Any.prototype.notes = function (notes) {
    ...
    Utils.assert(notes && (typeof notes === 'string' || Array.isArray(notes)), 'Notes must be a non-empty string or array');
...
internals.Any.prototype.tags = function (tags) {
    ...
    Utils.assert(tags && (typeof tags === 'string' || Array.isArray(tags)), 'Tags must be a non-empty string or array');
