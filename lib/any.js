...
internals.Any.prototype._validate = function (value, state, options) {
    ...
    state = state || { key: '', path: '', parent: null };
    ...
    if (this._invalids.has(value, state, this._flags.insensitive)) {
        errors.push(Errors.create(value === '' ? 'any.empty' : 'any.invalid', { value: internals.stringify(value) }, state, options));
    ...
    if (this._base) {
        ...
        if (base.value !== value) {
            ...
            if (this._invalids.has(value, state, this._flags.insensitive)) {
                errors.push(Errors.create('any.invalid', { value: internals.stringify(value) }, state, options));
                if (options.abortEarly) {
                    return finish();
                }
            }
...
internals.Set.prototype.add = function (value, refs) {
    ...
    Hoek.assert(value === null || value === undefined || value instanceof Date || (typeof value === 'function' && value.isJoi === true) || (typeof value !== 'function' && typeof value !== 'object'), 'Value cannot be an object or function');
