...
module.exports = internals.Any = function () {
    ...
    this._tests = [];
    this._flags = {};       // insensitive (false), allowOnly (false), default (undefined), encoding (undefined), allowUnknown (undefined)
...
internals.Any.prototype.clone = function () {
    ...
    obj._meta = this._meta; //@NOTE: should we shallow copy this?
...
internals.Any.prototype.concat = function (schema) {
    ...
    if (!obj._meta) {
      obj._meta = schema._meta;
    }
    else {
      obj._meta = Hoek.merge(obj._meta, schema._meta);
    }
...
internals.Any.prototype.meta = function (meta) {
    ...
    Hoek.assert(meta && (typeof meta === 'object'), 'Meta must be an object');

    var obj = this.clone();
    if (obj._meta) {
      this._meta = Hoek.merge(obj._meta, meta);
    } else {
      obj._meta = meta;
    }
