...
internals.Any.prototype.createError = function (type, context, state, options) {

    return Errors.create(type, context, state, options, this._localSettings);
};
...
internals.Any.prototype.clone = function () {
    ...
    obj._localSettings = internals.concatSettings(this._localSettings);
...
internals.Any.prototype.concat = function (schema) {
    ...
    obj._localSettings = internals.concatSettings(obj._localSettings, schema._localSettings);
...
internals.Any.prototype._test = function (name, arg, func, options) {
...
internals.Any.prototype.raw = function (isRaw) {
    ...
    const obj = this.clone();
    obj._localSettings.raw = isRaw === undefined ? true : isRaw;
    return obj;
};
...
internals.Any.prototype._validate = function (value, state, options, reference) {
    ...
    const finish = () => {
        ...
        if (!this._flags.strip) {
            if (value !== undefined) {
                finalValue = this._localSettings.raw ? originalValue : value;
            }
...
internals.Any.prototype.label = function (name) {
    ...
    const obj = this.clone();
    obj._localSettings.label = name;
    return obj;
};


internals.Any.prototype._getLabel = function (def) {

    return this._localSettings.label || def;
};
