...
internals.Any.prototype.when = function (ref, options) {
    ...
    const then = options.then ? this.concat(Cast.schema(options.then)) : undefined;
    const otherwise = options.otherwise ? this.concat(Cast.schema(options.otherwise)) : undefined;
