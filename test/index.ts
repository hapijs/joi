...
const func: () => void = () => { };
const errorCallback = (param: {source: 'array' | 'object', item: any; error: string}) => {};
...
validOpts = { stripUnknown: { arrays: bool, objects: bool, errorCallback: errorCallback} };
validOpts = { stripUnknown: { arrays: bool, errorCallback: errorCallback} };
validOpts = { stripUnknown: { objects: bool, errorCallback: errorCallback} };
validOpts = { stripUnknown: { arrays: bool, objects: bool, errorCallback: errorCallback} };
validOpts = { stripUnknown: { arrays: bool, errorCallback: errorCallback} };
validOpts = { stripUnknown: { objects: bool, errorCallback: errorCallback} };
...
const Joi4 = Joi.extend({ type: 'test4', base: schema }, { type: 'test4a', base: schema });

const Joi5 = Joi.extend({ type: 'test5', base: schema }, { type: 'test5a', base: schema }, { type: 'test5b', base: schema });
