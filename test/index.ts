...

{
  // validate tests
  {
    ...
    expect.type<Promise<{ value: TResult; artifacts: Map<any, string[][]> }>>(
      schema.validateAsync(value, { artifacts: true })
    );
    expect.type<Promise<{ value: TResult; warning: Joi.ValidationWarning }>>(
    ...
    expect.error<Promise<{ value: TResult; warning: Joi.ValidationWarning }>>(
      schema.validateAsync(value, { artifacts: true })
    );
    expect.error<Promise<{ value: TResult; artifacts: Map<any, string[][]> }>>(
      schema.validateAsync(value, { warnings: true })
    );
    expect.error<Promise<TResult>>(
      schema.validateAsync(value, { artifacts: true, warnings: true })
    );
    expect.type<Promise<TResult>>(
      schema.validateAsync(value, { artifacts: false })
    );
    expect.type<Promise<TResult>>(
      schema.validateAsync(value, { warnings: false })
    );
    expect.type<Promise<TResult>>(
      schema.validateAsync(value, { artifacts: false, warnings: false })
    );
